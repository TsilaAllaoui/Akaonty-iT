...
class EntryInput extends ConsumerStatefulWidget {
  const EntryInput({super.key});

  @override
  ConsumerState<EntryInput> createState() => _ExpenseInputState();
}

class _ExpenseInputState extends ConsumerState<EntryInput> {
